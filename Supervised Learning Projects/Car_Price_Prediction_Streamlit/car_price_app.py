...
with open('/Users/anands/DATA_SCIENCE/MACHINE_LEARNING/ML_projects/car_price_prediction/linear_model_car_price.pkl', 'rb') as f:
    lm2 = pickle.load(f)
...
final_fi = load_feature_importance("/Users/anands/DATA_SCIENCE/MACHINE_LEARNING/ML_projects/car_price_prediction/feature_importance.xlsx")  # Replace with your file path

# Sidebar setup
image_sidebar = Image.open('/Users/anands/DATA_SCIENCE/MACHINE_LEARNING/ML_projects/car_price_prediction/fig_123.png')  # Replace with your image file
...
# Top banner
image_banner = Image.open('/Users/anands/Downloads/cars.png')  # Replace with your image file
